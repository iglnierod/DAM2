...
fun LoginScreen(loginViewModel: LoginViewModel) {
    Box(
        ...
        val isLoading: Boolean by loginViewModel.isLoding.observeAsState(initial = false)
...
fun Body(modifier: Modifier, loginViewModel: LoginViewModel) {
    ...
    Column(modifier = modifier) {
        ...
        Spacer(modifier = Modifier.size(16.dp))
        LoginButton(isLoginEnable, loginViewModel) /*Añadimos la llamada loginViewModel*/
        Spacer(modifier = Modifier.size(16.dp))
        LoginDivider()
...
/*Añadimos el LoginViewModel para pasarle los datos externos*/
@Composable
